...
<div class="col-md-7"><!--Register section starts here-->
  ...
  <div class="default-padding">
    <ul class="list-unstyled">
      ...
      <li class=""><i class="fa fa-check-square-o" aria-hidden="true"></i> Monthly payments automatically withdrawn after trial period ends.</li>
    </ul>
  </div>
  <div class="spacer10f"></div>
  <form class="cmxform signup_frm form-horizontal" action="<?php echo $this->url('user/dopayment');?>" method="POST" id="payment-form" autocomplete="off">
    <input type="hidden" value="<?php echo (isset($signup_ts) && $signup_ts!='')?$signup_ts:''; ?>" name="signup_ts" />
    <p class="text-center text-danger" <?php if($this->resultSet['status']==1) { ?> style="display: none" <?php } ?>> <?php echo $this->resultSet['message']; ?></p>
    ...
    <div class="panel panel-default dopay_carpan">
      <div class="panel-heading">
        ...
        <img alt="stripe" src="<?php echo $this->images;?>stripe-logo.png" >
      </div>
      <div class="panel-body">
        ...
        <div class="col-lg-4 col-xs-12">
          <div class="form-group">
            <input type="password" size="4" onkeypress="return IsPhoneNumber(event);" placeholder="Card code *" maxlength="4" autocomplete="off" class="form-control card-cvc"  />
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="form-group text-center" >
      <div class="col-xs-12 ">
        <button type="submit" class="btn btn-primary btn-long" name="submit-button" value="Submit"> Submit</button>
      </div>
    </div>
...
<script type="text/javascript" src="<?php echo $this->assets."plugins/payment/jquery.payment.js";?>" ></script>
...
<script type="text/javascript" src="<?php  echo $this->assets."plugins/cc-validator/creditCardValidator.js";?>" ></script>
<script>
