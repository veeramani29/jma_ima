<?php $user_details = $this->resultSet['result']['userdetails']; ?>
<div class="col-xs-12 col-md-10">
	<form class="cancel_subscription" method="post">
		...
		<?php }?>
		<?php if(isset($this->resultSet['result']['cancelSubscriptionError']) && $this->resultSet['result']['cancelSubscriptionError']!= null) {?>
		<div id="Dv_flashMessage" style="color:red;" class="fullwidth"><div  class="flash_msg"><?php echo $this->resultSet['result']['cancelSubscriptionError'];?></div><div class="close_btn"></div></div>
		<?php }?>
		...
		<div class="text-center cansub_btns" >
			<button  type="button" onclick="location.href='<?php echo $this->url('user/myaccount/');?>'" class="btn btn-primary">Cancel</button>
