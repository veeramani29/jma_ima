...
<div class="col-md-9">
	<div class="panel panel-default full-width user_panel"> 
		...
		<div class="panel-footer text-center">
			<button  type="button" onclick="location.href='<?php echo $this->url('user/dopayment/');?>'" value="individual" class="form_submit_btn btn btn-primary btn-long">Proceed to payment details</button>
