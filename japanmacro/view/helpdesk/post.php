  ...
  <div class="panel-group">
    <div class="panel panel-default">
      <div class="panel-body">
        <?php if($this->resultSet['status']==4001) {
         echo "<p class='text-success'>".$this->resultSet['message']."</p>";
       } else {?>
       <form role="form" class="form-horizontal" name="frm_helpdesk" action="<?php echo $this->url('helpdesk/post');?>" method="post">
         <p>
           <?php if($this->resultSet['status'] == 3332) {
             echo "<p class='text-danger'>".$this->resultSet['message']."</p>";
