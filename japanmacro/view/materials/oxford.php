...
<div class="col-xs-12 col-md-10">
	<div class="row">
		<div class="col-md-12">
			...
			<div class="row">
				<div class="col-md-6">
					<img style="width: 100%;" alt="Oxford Economics" src="<?php echo $this->images;?>oe_logo.png"  />
				</div>
				<div class="col-md-6">
					<img style="width: 100%;" alt="Japan Macro Advisors" src="<?php echo $this->images;?>logo.png"  />
				</div>
			</div>
			<div class="row">
				<div class="col-md-12">
					...
					<p>
						...
						href="<?php echo $this->url('materials/category/oxford-economics/');?>#request_info">こちら</a>、もしくは、弊社（Japan
						...
						<table class="table">
							...
							<tr>
								<td class="text-center">
									...
									<a href="<?php echo $this->url('materials/download/'.$id.'/'.$material_path);?>" target="_blank">
										<img src="<?php echo $this->url('/').$title_image;?>" height="220px" alt="title image"></a>
										<?php }else{
							...
							<div class="col-md-12">
								<form action="" class="form-horizantal" method="post">
									...
									<div class="form-group">
										...
										<div class="col-md-8">
											<input type="text" style="margin-top: 5px" value="<?php echo isset($this->resultSet['result']['postvars']['name']) ? $this->resultSet['result']['postvars']['name'] : (isset($_SESSION['user']['fname']) ? $_SESSION['user']['fname'].' '.$_SESSION['user']['lname'] : '');?>" id="req_name"
									...
									<div class="form-group">
										...
										<div class="col-md-8">
											<input type="text" style="margin-top: 5px" value="<?php echo isset($this->resultSet['result']['postvars']['phone']) ? $this->resultSet['result']['postvars']['phone'] : (isset($_SESSION['user']['phone']) ? $_SESSION['user']['phone'] : '');?>" id="req_phone"
									...
									<div class="form-group">
										...
										<div class="col-md-8">
											<input type="text" style="margin-top: 5px" value="<?php echo isset($this->resultSet['result']['postvars']['email']) ? $this->resultSet['result']['postvars']['email'] : (isset($_SESSION['user']['email']) ? $_SESSION['user']['email'] : '');?>" id="req_email"
