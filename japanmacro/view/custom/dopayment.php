...
<div class="register_content_outer">
	...
	<div style="float:left;padding-left:4px;"><b>PREMIUM Subscription plan -Annual</b></div>	
</div>
<div class="fontsize12" style="width:500px; float:left;">
<ul>
	<li>Costs <?php echo $CONF_CURRENCY." "."37,800";?> a year.<br /></li>
	
<li>Yearly payments automatically withdrawn every year.<br /><br /></li>
</ul>
</div>
<div class="fontsize12" style="width:500px; float:left;">
...
<div class="dopay_input fontsize12">
	...
	<div class="register_box_input">
		<input type="text" size="2"  maxlength="2" onkeypress="return IsPhoneNumber(event);" placeholder="MM *" name="card-expiry-month" value="<?php echo (isset($_REQUEST['card-expiry-month']))?$_REQUEST['card-expiry-month']:'';?>" class="form_textfield_payment card-expiry-month" style="width: 25%;display: inline-block;"/>
        <span> / </span>
		<input type="text" size="4" maxlength="4" onkeypress="return IsPhoneNumber(event);" placeholder="YYYY *" name="card-expiry-year" value="<?php echo (isset($_REQUEST['card-expiry-year']))?$_REQUEST['card-expiry-year']:'';?>" class="form_textfield_payment card-expiry-year" style="width: 25%;display: inline-block;"/>
	</div>
</div>
<div class="dopay_input fontsize12">
