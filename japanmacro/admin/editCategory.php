		...
		if($category == ''){
			$errorMsg ='Please enter Categories<br/>';
				  ...
				  {  
		        	...
		        	$catObj->updteCategories2($id,$category, $meta_title, $meta_keywords, $meta_desc,$get_title,$key,$post_category_parent_id,$get_category_type,$get_category_link,$email_alert,$default_email_alert);
