	...
	*/
	...
	function getPostList(){
		...
		function selectEmailAlertMembers($catId)
		{
            ...
            $this->db->open();
            $query   = "SELECT u.fname AS name ,u.email AS address FROM user_accounts AS  u  WHERE ((FIND_IN_SET('$catId',want_to_email_alert)>0) AND breaking_News_Alert = 'Y') ORDER BY u.id DESC";
