...
class chart {
	...
	*/
	function getChartList(){
	 ...
	 function updateGraphdetails($id,$source,$title,$txt,$is_premium,$xfile){

            $this->db->open();

            $query_pag_data   = "update graph_details set  source = '$source', title = '$title', description ='$txt',isPremium = '$is_premium', filepath ='$xfile' where gid = '$id'";
