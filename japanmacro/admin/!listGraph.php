			...
			<div id="table-content">
				...
				<tr>
                  ...
                  <tr class="<?php echo $class?>">	 
					...
					<td><?php echo trim(editorfix($getGraph[$i]['description']));?></td>
					<td><textarea cols="50" rows="3"><?php echo '<iframe  width="600" height="900"  frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="http://japanmacroadvisors.com/graph.php?gid='.$getGraph[$i]['gid'].'"></iframe>';//echo '<iframe id="ListFrame" name="ListFrame" style="width:600px; height:900px;border:1px" src="graph.php?gid='.$getGraph[$i]['gid'].'"></iframe>'; ?></textarea></td>
					<td class="options-width">
					<a href="editGraph.php?id=<?php echo $getGraph[$i]['gid'];?>" title="Edit" class="icon-1 info-tooltip"></a>
					<a href="listGraph.php?delete=true&gid=<?php echo $getGraph[$i]['gid'];?>" title="Delete" class="icon-2 info-tooltip"></a>					</td>
				</tr>
                                <?php
                                       }
                                   }
