...
<div class="app-body indigo  bg-auto w-full">
  <div class="text-center pos-rlt p-y-md">
    <h1 class="text-shadow m-a-0 text-white text-4x">
      <span class="text-2x font-bold block m-t-lg">5XX</span>
    </h1>
    <h2 class="h1 m-y-lg text-black">OOPS! Database Error</h2>
    <p class="h5 m-y-lg text-u-c font-bold text-black"><?php echo $heading; ?></p>

    
        <?php echo $message; ?>
                
               
                <button class="md-btn amber-700 md-raised p-x-md" onclick="history.back()">Go Back to Previous Page</button> &nbsp; 
               
                 <button onclick="location.href='<?php echo HOST_ADMIN;?>dashboard'" class="md-btn amber-700 md-raised p-x-md">Go Back to Dashboard</button>
