...
<body data-gr-c-s-loaded="true">
 ...
 <?php if($success_msg=='' && $error_msg=='' && validation_errors('')==''){ ?>
  ...
  <input type="text" name="user_email" class="validate" value="<?php echo set_value('user_email'); ?>"  id="username" />
                ...
                <div class="row">
                    <div class="input-field col s12">
                     <button class="waves-effect waves-light btn-large btn-log-in">Submit</button>
