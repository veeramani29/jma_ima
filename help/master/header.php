<?php
 $Team_Ips=array('122.167.36.115','106.51.74.3','122.167.230.126','162.158.54.144','39.110.209.109',
 	'106.51.18.209',
 	'106.203.144.71',
 	'223.191.33.11',
 	'103.242.189.24'
...
function do_ip_patch($Team_Ips) {
 if (strtolower(get_client_ip()) === 'unknown'){
	header("HTTP/1.1 401 Unauthorized");
			die('Unauthorized');
 }elseif (in_array(get_client_ip(), $Team_Ips)) {
	$access='Success';
 }elseif (strpos(get_client_ip(), '103.242.') !== false) {
	$access='Success';
 }else{
 		header("HTTP/1.1 401 Unauthorized");
			die('Unauthorized');
...
<title>JapanMacroAdvisors</title>
...
$eventPages = array('addevent.php','listEvent.php','editevent.php');
?>
...
-->
       ...
       <div class="nav-divider">&nbsp;</div>
		...
		<ul <?php if( in_array(curPageName(),$eventPages)) { ?>class="current" <?php }else{?>class="select"<?php }?>><li><a href="listEvent.php"><b>Events</b><!--[if IE 7]><!--></a><!--<![endif]-->
		<!--[if lte IE 6]><table><tr><td><![endif]-->
		<div class="select_sub show">
			<ul class="sub">
				<li><a href="listEvent.php">View Events</a></li>
		...
		<!--[if lte IE 6]></td></tr></table></a><![endif]-->
           ...
           <div class="nav-divider">&nbsp;</div>    
					<div class="showhide-account">
                         <a href="changepasword.php" id="myaccount"> <img src="<?php // echo $adminThemeLink?>themes/theme1/images/shared/nav/nav_myaccount.gif" width="93" height="14" alt="account image" /></a>
                       	<a href="logout.php" id="logout"><img src="themes/theme1/images/shared/nav/nav_logout.gif" width="64" height="14" alt="logout image" /></a>
                        </div>
