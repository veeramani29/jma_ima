...
<script language="javascript">
  ...
  $("input[name='default_email_alert']").click(function() {

if($(this).val()=='Y'){
    $('#default_premium_email_alert').show();
}else{
     $('#default_premium_email_alert').hide()
}
...
$premium_category = $someobj['premium_category'];
$default_premium_email_alert = $someobj['default_premium_email_alert'];
 ...
 $insertArray = array();
  if(isset($_POST['categoryAdd'])){
	...
	if($_POST['categoryAdd']){
                ...
                $premium_category = $_POST['premium_category'];
                $default_premium_email_alert = $_POST['default_premium_email_alert'];
		...
		if($category == ''){
			$errorMsg ='Please enter Categories<br/>';
				  ...
				  {  
							  ...
							  if($_POST['default_email_alert']=="N")
							  {
								  ...
								  foreach($want_user_list as $key=>$values)
								  {
									  ...
									  $arrtoCate = explode(",",$sdsss);
										   ...
										   $key_ = array_search($catTd,$arrtoCate);
										   unset($arrtoCate[$key_]);
		        	...
		        	$catObj->updteCategories2($id,$category, $meta_title, $meta_keywords, $meta_desc,$get_title,$key__,$post_category_parent_id,$get_category_type,$get_category_link,$email_alert,$default_email_alert,$premium_category,$default_premium_email_alert);
		...
		<!-- start id-form -->
				...
				<?php if($alert_mail == 'Y') { ?> 
				 <tr id="show_default_alert">
                    ...
                    <tr id="default_premium_email_alert">
                    <th>Is this premium default email alert?</th>
                    <td>
                            <input type="radio" value="Y" name="default_premium_email_alert" id="default_premium_email_alert" <?php if($default_premium_email_alert == 'Y') { echo "checked"; } ?> /> Yes
                            <input type="radio" value="N" name="default_premium_email_alert" id="default_premium_email_alert" <?php if($default_premium_email_alert == 'N') { echo "checked"; } ?> /> No
                    </td>
                    <td></td>
                </tr>
				...
				<?php } else {?>
                    ...
                    <tr id="default_premium_email_alert" style="display:none;">
                    <th>Is this premium default email alert?</th>
                    <td>
                            <input type="radio" value="Y" name="default_premium_email_alert" id="default_premium_email_alert"  /> Yes
                            <input type="radio" value="N" checked name="default_premium_email_alert" id="default_premium_email_alert"  /> No
                    </td>
                    <td></td>
                </tr>
                ...
                <?php }?>   
                 ...
                 <tr>   
                    ...
                    <td >
                            <input type="radio" value="Y" name="premium_category" id="premium_category"   <?php if($premium_category == 'Y') { echo "checked"; } ?> /> Yes
							<input type="radio" value="N" name="premium_category" id="premium_category"   <?php if($premium_category == 'N') { echo "checked"; } ?> />  No
