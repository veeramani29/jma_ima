	...
	if($_POST['categoryAdd']){		
            ...
            //    }
                 ...
                 $insertArray['post_category_status']  = 'Y';
                   $insertArray['premium_category']  = isset($_POST['premium_category'])?$_POST['premium_category']:'N';
				...
				<div class="error_sent_notification"><?php echo $errorMsg;?></div>
	             <?php } ?>
                   ...
                   <tr>   
                    ...
                    <td >
                            <input type="radio" value="Y" name="premium_category" id="premium_category"   /> Yes
              <input type="radio" value="N" name="premium_category" id="premium_category"   />  No
