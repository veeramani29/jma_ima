 ...
 * BSD style license, as supplied with this software.DataTables_sort_wrapper
 * 
			...
			for ( var i=0 ; i<aDom.length ; i++ )
			{
				...
				if ( cOption == '<' )
				{
					...
					if ( cNext == "'" || cNext == '"' )
					{
						...
						if ( sAttr == "H" )
						{
							sAttr = "fg-toolbar ui-toolbar ui-widget-header ui-corner-tl ui-corner-tr ui-helper-clearfix toolbar_top";
						}
						else if ( sAttr == "F" )
						{
