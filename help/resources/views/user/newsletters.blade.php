...
if(Session::has('unsubscribe_ts'))
{

  $unsubscribe_ts  = Session::get('unsubscribe_ts');
}
if(empty($unsubscribe_ts))
{
  $unsubscribe_ts  = time();
  Session::put('unsubscribe_ts',$unsubscribe_ts);
...
<div class="main-title">
 ...
 <div class="panel-group">
    <div class="panel panel-default">
     ...
     <div class="sub-title">
 <h5 >If you would like to receive alerts for new reports, please enter your email and hit submit.</h5>
<div class="sttl-line"></div>
  ...
  <form class="form-horizontal" name="unsubscribe_frm" id="unsubscribe_frm"  method="post"  >
