		...
		<div itemscope itemtype="http://schema.org/Article">
			...
			<div class="folussoc_con fus_indicator">
				<ul class="list_socail">
					<li class="fs_whatsapp" data-toggle="tooltip" title="WhatsApp">
						<a href="javascript:void(0)" title="Share on whatsapp" class="commonShare" stype="whatsapp">
							<i class="fa fa-whatsapp" aria-hidden="true"></i>
						</a>
					</li>
					<li class="fs_print" data-toggle="tooltip" title="Print&nbsp;Page">
						<a href="javascript:void(0)" title="Print" class="commonShare" >
			...
			<?php if(!empty($resn[0]['post_image']) && $resn[0]['post_image']!='') { ?>
			<p><img width="640" height="360" src="public/uploads/postImages/<?php echo $resn[0]['post_image']; ?>" alt="Bearking Reports Image"></p>
			<?php } ?>
