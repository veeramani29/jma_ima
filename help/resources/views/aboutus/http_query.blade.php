...
<div class="main-title">
 ...
 <div class="panel-group">
    <div class="panel panel-default">
     ...
     <div class="sub-title">
 <h5 >If you would like to build http query, please deatils.</h5>
<div class="sttl-line"></div>
  ...
  <div class="form-group">
    ...
    <div class="col-md-10">
      <textarea  required class="form-control" name="encryption" id="encryption" value="<?php echo $encryption; ?>" >array('dfdfdf':'sdsd',
      'dfdfdf':'sdsd',
    'dfdfdf':'sdsd'
  )</textarea> 
    </div>
