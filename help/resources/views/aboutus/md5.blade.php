...
<div class="main-title">
 ...
 <div class="panel-group">
    <div class="panel panel-default">
     ...
     <div class="sub-title">
 <h5 >If you would like to do md5 encryption, please enter your string/text and hit submit.</h5>
...
<div class="text-center alert alert-success alert-dismissible" role="alert">
 ...
 <?php } ?>
  <div class="form-group"> 
    <div class="col-md-12 text-center">
      <button type="submit"  name="encryption_btn" class="btn btn-primary"><i class="fa fa-angle-double-right"></i> Submit</button>
    </div>
  </div>
</form>
 ...
 <div class="panel-group">
    <div class="panel panel-default">
     ...
     <div class="sub-title">
 <h5 >If you would like to do md5 decryption, please enter your string/text and hit submit.</h5>
<div class="sttl-line"></div>
    </div>
...
<div class="text-center alert alert-success alert-dismissible" role="alert">
 ...
 <?php } ?>
  <div class="form-group"> 
    <div class="col-md-12 text-center">
      <button type="submit"  name="decryption_btn" class="btn btn-primary"><i class="fa fa-angle-double-right"></i> Submit</button>
    </div>
  </div>
</form>
