...
<div class="main-title">
      <h1>Square/Cube Root of number</h1>
 ...
 <div class="panel-group">
    <div class="panel panel-default">
     ...
     <div class="sub-title">
 <h5 >If you would like to do Square/Cube root of number, please enter number.</h5>
<div class="sttl-line"></div>
  ...
  <div class="form-group">
    <label class="col-md-2"  for="email">Number:</label>
    <div class="col-md-10">
      <input type="Number"  required class="form-control" name="encryption" id="encryption" value="<?php echo $encryption; ?>" placeholder="Enter Url">
    </div>
  </div>
 ...
 <?php } ?>
  <div class="form-group"> 
    <div class="col-md-12 text-center">
      <button type="submit" value="encode"  name="button" class="btn btn-primary"><i class="fa fa-angle-double-right"></i>   <sup>2</sup> &radic;</button>
      <button type="submit" value="decode"  name="button" class="btn btn-primary"><i class="fa fa-angle-double-right"></i> <sup>3</sup> &radic;</button>
    </div>
