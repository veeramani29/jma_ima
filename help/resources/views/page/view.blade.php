	...
	<div itemscope itemtype="http://schema.org/Article">
		...
		<div class="folussoc_con fus_indicator">
			<ul class="list_socail">
				<li class="fs_whatsapp" data-toggle="tooltip" title="Share on Whatsapp">
					<a href="javascript:void(0)" class="commonShare" link_input_id="common_share_url" stype="whatsapp"><i class="fa fa-whatsapp" aria-hidden="true"></i></a>
				</li>
