...
class ReportsController extends Controller {
	...
	public function view(Request $request) {
		...
		if(count($params) == 1){ 
			if($params[0] == 'indias-balance-of-payment-19912019-robust-capital-inflows-crucial-to-indias-bop'){ 
				return redirect('reports/view/reports/'.$params[0]);	
			}
		...
		if($isContentAllowed == true) {
			...
			$renderResultSet['meta']['shareTitle']=isset($newsContent[0]['post_share_title'])?$newsContent[0]['post_share_title']:'';
			$renderResultSet['meta']['description']=isset($newsContent[0]['post_share_description'])?$newsContent[0]['post_share_description']:'';
			$renderResultSet['meta']['metaTitle']=isset($newsContent[0]['post_meta_title'])?$newsContent[0]['post_meta_title']:'';
