                    ...
                    //$doc_path1 = '';
                     ...
                     if($_FILES['graph_File']['name'] != ''){                       
							...
							if(file_exists('../public/uploads/xls/'.$xlFile))
							{
							    ...
							    $xlFile=str_replace(" ","_",$extArr[0]).date('dmyhis').$ext;
							}
                               ...
                               {   
								...
								$insertArray['isPremium']    = $graphIsPremium;
								$insertArray['filepath']     = $xlFile;
                                $insertArray                 = cleanInputArray($insertArray);
                                $insertId=$chartObj->addMapGraph($insertArray);
					            // excel reader start
					            if($file2Uploaded == 1){
									$sheetno=0;
...
######################################
									...
									/* echo  count($data[0]);
									echo  count($dataArray1[1]);
									 echo "<pre>";print_r($dataArray1);echo "</pre>";
									 echo "<pre>";print_r($data[0]);echo "</pre>";exit;  */
								   
									// echo "<pre>";print_r($dataArray1);echo "</pre>";exit;
									 //echo $dataArray1[2][1];echo "<br>";exit;
...
<div id="page-heading"><h1>Add Map</h1></div>
	             ...
	             <?php } ?>
                    ...
                    <tr>
                            ...
                            <td colspan="2">
                                ...
                                <textarea  name="graph_txt" id="graph_txt" cols="22" rows="8"  ></textarea>
					...
					<tr>
                            ...
                            <td colspan="2">
                                ...
                                <input type="checkbox" name="isPremium" value="y">
