...
$errorMsg = '';
	...
	$insertArray = array();
	$myemail = $postObj->getEmailDetails($id);
	
	
	$insertArray['email_templates_code'] = $myemail[0]['email_templates_code'];
	$insertArray['email_templates_subject'] = $myemail[0]['email_templates_subject'];
	$insertArray['email_templates_message'] = stripslashes($myemail[0]['email_templates_message']);
	$insertArray['email_templates_variable'] = $myemail[0]['email_templates_variable'];
  ...
  if(isset($_POST['postAdd'])){
                ...
                if($code == '' ||  $subj == '' || $message == '' || $varia == ''){
                    ...
                    try
					{
						$postObj->updateMailTemplate($updateId,$code,$subj,$message,$varia);
						$successMsg = "Mail Template updated successfully.";
						$insertArray = array(); 
						echo $successMsg;
						header('Location:listEmail.php');
                    } 
...
<div id="page-heading"><h1>Edit Email Template</h1></div>
                ...
                <div class="error_sent_notification"><?php echo $errorMsg;?></div>
                 <?php } ?>
                    ...
                    <tr>
                            ...
                            <td>
                                <input type="text" name="email_code"  id="email_code" class="inp-form2" value="<?php echo $insertArray['email_templates_code']; ?>" />
                    ...
                    <tr>
                            ...
                            <td>
                                <input type="text" name="email_sub" id="email_sub" class="inp-form2" value="<?php echo $insertArray['email_templates_subject']; ?>" />
                     ...
                     <tr>
                            ...
                            <td>
                                <textarea  name="mail_message" id="mail_message" cols="5" rows="8"  ><?php echo $insertArray['email_templates_message']; ?></textarea>
                      ...
                      <tr>
                            ...
                            <td>
                                 <textarea name="email_vari" id="email_vari" rows="" cols="" class="form-textarea"  ><?php echo $insertArray['email_templates_variable']; ?></textarea>
