...
$lines = $db->selectQuery("SELECT y_value, y_sub_value, min(vid) FROM map_values where gid = '".$id."' GROUP BY y_value, y_sub_value order by min(vid)");
?>
<div id="content-outer">
<!-- start content -->
<div id="content">
<div id="page-heading"><h1>View Map Graph</h1></div>
