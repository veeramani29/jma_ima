...
$seopage = $seopages->getPagetDetails($id);
$insertArray['id'] = $seopage[0]['id'];
$insertArray['title'] = $seopage[0]['title'];
$insertArray['slug'] = $seopage[0]['slug'];
$insertArray['slug_hash'] = $seopage[0]['slug_hash'];
$insertArray['meta_title'] = $seopage[0]['meta_title'];
$insertArray['meta_description'] = $seopage[0]['meta_description'];
$insertArray['mata_keywords'] = $seopage[0]['mata_keywords'];
$insertArray['post_id'] = $seopage[0]['post_id'];
$insertArray['content'] = $seopage[0]['content'];
...
if(isset($_POST['postAdd'])){
	...
	if($title == '' || $slug == '' || $meta_title == '' || $meta_description == '' || $mata_keywords == ''){
		...
		try{
			$postId = $seopages->updateSeoPage($insertArray);
			header('Location:listseopages.php');
		} catch (Exception $ex) {
...
<div id="page-heading"><h1>Edit SEO PAGE</h1></div>
	             ...
	             <?php } ?>
                    ...
                    <tr>
                     ...
                     <tr>
                            ...
                            <td id="select_post">    
                            Selected Post Id : <?php echo $insertArray['post_id'];?>                                
                            </td>
                            <td></td>
                    </tr>
                    ...
                    <tr>
                            ...
                            <td>
                                <input type="text" name="post_title"  id="post_title" class="inp-form2" value="<?php echo $insertArray['title'];?>" />
                    ...
                    <tr>
                            ...
                            <td>
                                 <input type="text" name="post_url_slug" id="post_url_slug" class="inp-form2" value="<?php echo $insertArray['slug'];?>" />
                     ...
                     <tr>
                            ...
                            <td>
                                 <input type="text" name="meta_title" id="meta_title" class="inp-form2" maxlength="250" value="<?php echo $insertArray['meta_title'];?>" />
                    ...
                    <tr>
                            ...
                            <td>
                                 <input type="text" name="meta_keywords" id="meta_keywords" class="inp-form2" maxlength="250" value="<?php echo $insertArray['mata_keywords'];?>" />
                    ...
                    <tr>
                            ...
                            <td>
                                 <input type="text" name="meta_description" id="meta_description" class="inp-form2" maxlength="1024" value="<?php echo $insertArray['meta_description'];?>" />
                                 <label for="meta_description" class="error" id="meta_description_error"></label>
                            </td>
                            <td></td>
                    </tr>                   

                     <tr class="existing_post" <?php if($insertArray['post_id'] > 0){?> style="display:none"<?php }?>>
                            <th valign="top"> Post</th>
                            <td>
                                <textarea  name="post_content" id="post_content" cols="5" rows="8"  ><?php echo $insertArray['content'];?></textarea>
