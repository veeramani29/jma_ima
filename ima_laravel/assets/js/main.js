...
define(['module','require','jquery','jqueryCookieBar','jqueryValidate','bootstrap','Jma','datepicker'], function(module,require,$,jqueryCookie,jqueryValidate,bootstrap,JmaCla,datepicker){
	$.ajaxSetup({
        headers: {
