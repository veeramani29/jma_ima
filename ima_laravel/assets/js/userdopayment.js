...
define(['module','require','jquery','jqueryCookieBar','jqueryValidate','bootstrap','mobiledetect','Jma','intlTelInputMin',], function(module,require,$,jqueryCookie,validate,bootstrap,JmaCla,intlTelInput){
	var Jma = require('Jma');
