...
<?php if ($user_details['user_type']!='corporate'){
	...
	<form id="form_submit_subscription_request" class="form-horizontal well box myacc_subform"  method="post" action="<?php echo url('user/myaccount/subscription');?>">
		...
		<div class="col-md-5 upgradetext pad0">
		...
		<div class="col-xs-12 col-sm-6 col-md-4">
			<div class="signup_request_select activepro" id="premium">
	...
	<?php if(isset($_SESSION['user'])){
		...
		<br>
		<p class="myacc_cansubs">If you would like to cancel your <?php echo ucfirst($user_details['user_type']); ?> subscription, contact <a href="mailto:support@indiamacroadvisors.com">support</a> or submit your query to <a href="<?php  echo url('helpdesk/post');?>">Help Desk.</a></p>
		<?php } } ?>
