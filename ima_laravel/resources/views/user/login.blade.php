...
<div class="col-md-10 col-xs-12 loginpage_con">
  ...
  <div class="alert alert-warning" role="alert">  
    ...
    <p>This content is restricted <b>for paying users only.</b> If you are a PREMIUM account user, please log-in.</p>
            ...
            <div class="form-group text-center">
              ...
              <div class="col-xs-6 text-center">
                <a href="<?php echo url('auth/login/facebook',isset($product)? $product : 'free');?>"
                 ...
                 onclick="window.open(this.href, '_blank','width=600,height=600,scrollbars=yes,status=yes,resizable=yes,screenx='+((parseInt(screen.width) - 600)/2)+',screeny='+((parseInt(screen.height) - 600)/2)+'');return false;" style="background: #3b5998;padding: 14px;color: #FFF;"   title="Facebook Signup" > 
