      ...
      <div class="tab-pane fade in <?php echo $result['tabname'] == 'profile' ? 'active' : '';?>" id="profile">
        ...
        <form class="cmxform signup_frm form-horizontal" name="Form_user_profile_edit" id="Table_user_profile_edit" method="post" action="<?php echo url('user/editprofile');?>" style="display: none;">
          ...
          <div class="form-group">
            ...
            <div class="col-xs-12 col-sm-8">
              <input type="hidden"  name="isd_code" id="isd_code" value="<?php echo ((isset($_REQUEST['isd_code']))?$_REQUEST['isd_code']:(($user_details['country_code']!=null)?$user_details['country_code']:'+91'));?>"  class="card-isd-code" >
                    ...
                    <li>
                      <div class="full-widthf">
                        <label class="control control--checkbox">Thematic reports
                          <input type="checkbox" value="" name="thematic_report" class="email_alert" id="thematic_report" class="email_alert" onclick="return issetThematicReports('<?php echo $defultAlertValue; ?>','<?php echo $allemailCategory; ?>');" <?php echo $user_details['breaking_News_Alert'] == "Y" ? 'checked' : '';?>>
                          <span class="control__indicator"></span>
                        </label>
                      </div>
                    </li>
