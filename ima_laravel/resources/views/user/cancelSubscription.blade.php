...
<form  method="post">
		...
		<p id="Dv_flashMessage" class="text-center text-success"><div class="flash_msg activemsg"><?php echo $_SESSION['message']?$_SESSION['message']:'';?></div><div class="close_btn"></div></p>
		<?php } ?>
