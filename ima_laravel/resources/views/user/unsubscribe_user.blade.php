				   ...
				   <li>
					<div class="full-widthf">
					  <label class="control control--checkbox"> Remove all
						<input type="checkbox" value="" name="remove_box" id="remove_box" onclick="return removeallEmail();" <?php echo (($user_details[0]['want_to_email_alert'] == 0) && $user_details[0]['breaking_News_Alert'] == 'N')  ? 'checked' : '';?>>
						<span class="control__indicator"></span>
					  </label>
					</div>
				  </li>
				  ...
				  <li>
					<div class="full-widthf">
					  <label class="control control--checkbox">Thematic reports
						<input type="checkbox" value="y" name="thematic_report" class="email_alert" id="thematic_report" onclick="return issetThematicReports('<?php echo $defultAlertValue; ?>','<?php echo $allemailCategory; ?>');" <?php echo $user_details[0]['breaking_News_Alert'] == "Y" ? 'checked' : '';?>>
						<span class="control__indicator"></span>
					  </label>
					</div>
				  </li>
