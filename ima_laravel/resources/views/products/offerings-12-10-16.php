...
<link rel='stylesheet'  href='http://fonts.googleapis.com/css?family=Open+Sans%3A400%2C300%2C400italic%2C700&#038;ver=4.5.3' type='text/css' media='all' />
...
<link rel='stylesheet'  href='<?php  echo $this->css."fullpage.css";?>' type='text/css' media='all' />
<!--<link rel='stylesheet'  href='css/prettyPhoto.css' type='text/css' media='all' />-->
<link rel='stylesheet'   href='<?php  echo $this->css."style.css";?>' type='text/css' media='all' />

<!--[if lte IE 8]>
<link rel='stylesheet' id='pexeto-ie8-css'  href='css/style_ie8.css?ver=1.8.2' type='text/css' media='all' />
<![endif]-->
<script type='text/javascript' src='<?php  echo $this->javascript."jquery.js";?>'></script>
        ...
        <!--HEADER -->
            ...
            <div class="section-boxed section-header">
                        <div id="logo-container">
                                <a href="#1"><img src="<?php  echo $this->images."product/";?>logo.png" alt="JMA Landing" /></a>
            </div>  
...
<li id="menu-item-202" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-202"><a href="#">About us</a></li>
<li id="menu-item-203" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-203"><a href="#">Contact</a></li>
<li id="menu-item-204" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-204"><a href="#">Our Privacy Policy</a></li>
<li id="menu-item-205" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-205"><a href="#">Commercial Policy</a></li>
</ul>               </div>
...
<!-- change 12Sep
<div class="section section-text layout-ct" style="background-image:url(<?php  echo $this->images."product/";?>hand-drawn_bg.jpg);background-color:#17C5CC;background-position:center center;">
...
<!--add 12Sep -->
<div class="section section-textimg layout-left" style="background-image:url(<?php  echo $this->images."product/";?>hand-drawn_bg.jpg);background-color:#17C5CC;background-position:center center;">
...
<div class="section section-textimg layout-left" style="background-color:#242D3C;background-position:center center;">
    <div class="section-wrapper">
        <div class="section-img anim-el"><img src="<?php  echo $this->images."product/";?>report.png" alt=""/></div>
            <div class="section-content anim-el">
        ...
        <div class="section-img anim-el">
          <div class="price-table-wrapper">
                ...
                <div class="col pt-col pt-non-highlight">
                    ...
                    <div class="pt-button"><a class="button" href="#7"  >Register NOW</a></div>
                </div>
                ...
                <div class="col pt-col pt-highlight">
                    ...
                    <div class="pt-button"><a class="button" href="#7"  >30 days Free Trial</a></div>
               </div>
               ...
               <div class="col pt-col pt-non-highlight">
                   ...
                   <div class="pt-button"><a class="button" href="#7"  >Request Info</a></div>
               </div>
...
<div class="section section-text layout-cc" style="background-image:url(<?php  echo $this->images."product/";?>coverphoto.jpg);background-position:center center;">
    <div class="section-content anim-el">
        ...
        <a  style="background-color:#F15525;" href="#" class="button">Register NOW</a>
    </div>
</div>
...
<script type='text/javascript' src='<?php  echo $this->javascript."main.js";?>'></script>
<script type='text/javascript' src='<?php  echo $this->javascript."fullpage.js";?>'></script>
