...
if(isset($result['status']) && $result['status']!=1) {
 # $signup_error_id = $result['signup_error_id'];
  ...
  $email = $result['postdata']['email'];
    $agreeButton = isset($result['postdata']['agreeButton'])?$result['postdata']['agreeButton']:'';
  ...
  $phone_code = isset($result['postdata']['phone_code'])?$result['postdata']['phone_code']:'';
   $country_code = str_replace("+", "", $result['postdata']['country_code']);
            ...
            <nav class="navigation-container">
              <div id="menu" class="nav-menu">
                <ul id="menu-main-menu" class="menu-ul">
                  <li id="menu-item-206" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-206"><a target="_blank" href="<?php echo url('');?>">Home</a></li>
                  ...
                  <li id="menu-item-202" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-202"><a target="_blank" href="<?php echo url('/aboutus');?>">About IMA</a></li>
                  <li id="menu-item-203" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-203"><a target="_blank" href="<?php echo url('/contact');?>">Contact</a></li>
                  <li id="menu-item-204" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-204"><a target="_blank" href="<?php echo url('/aboutus/privacypolicy');?>">Our Privacy Policy</a></li>
                    ...
                    <form class="signup_frm" name="signup_frm" id="signup_frm" action="<?php echo url('user/signup');?>" method="post" autocomplete="off" novalidate="novalidate">
                      ...
                      <p align="center" class="text-danger" <?php if(isset($result['status']) && $result['status']!=1) { ?> style="display: none"
                        ...
                        <div class="cols-2 btn_regbtn" >
                          ...
                          <div class="col text-center" style="margin-left: 25%;">
                        ...
                        <div class="cols-1 brb_lininbtn" >
                          <div class="col" >
                              <a href="<?php echo url('user/linkedinProcess/premium');?>" class="reg_linkedin linkedIn btn btn-lisu">
                                <i class="fa fa-linkedin"></i> Sign up
                              </a>
                             <a class="reg_fb btn btn-fbsu" onclick="window.open(this.href, '_blank','width=600,height=600,scrollbars=yes,status=yes,resizable=yes,screenx='+((parseInt(screen.width) - 600)/2)+',screeny='+((parseInt(screen.height) - 600)/2)+'');return false;" href="<?php echo url('auth/login/facebook/premium');?>"> 
                            <i class="fa fa-facebook"></i> Sign up
                            </a> 
                            <!-- <a class="reg_linkedin"  href="<?php echo url('user/linkedinProcess');?>">
                          ...
                          @if ($errors->any())
    <div style="color: red;font-size: 20px;" class="alert alert-danger">
...
@endif
                          ...
                          <div class="cols-2">
                            ...
                            <div class="col">
                              <div class="form-control su_couinp">
                                <input type="hidden" data-old="<?php echo ($country_code!='')?$country_code:'+91';?>"   value="<?php echo ($country_code!='')?$country_code:'+91';?>" name="country_code"   id="country_code"   />
                      ...
                      <div class="col">
                      <div class="g-recaptcha" name="g-recaptcha" id="g-recaptcha" data-sitekey="6Ldi32wUAAAAAADV4QEghtctMIptO3e7WS8i94N6">
                      </div>
               ...
               <input type="checkbox" value="y" id="agreeButton" <?php echo (isset($agreeButton) && $agreeButton=='y')?'checked':'';?> name="agreeButton" class="required">         Agree with the <a id="terms" target="_blank" href="<?php echo url('aboutus/termsofuse');?>"> terms and conditions </a>
...
$("#signup_frm").validate({
  ...
  if (element.attr("name") == "agreeButton") {
