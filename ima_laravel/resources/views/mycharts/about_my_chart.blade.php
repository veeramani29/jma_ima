...
<div class="abochar_container">
  <div class="col-xs-12">
    <h1 class="text-center">With My Chart, making chart book has never been easier</h1>
  ...
  <div class="spacer10"></div>
  <div class="col-xs-12"><hr></div>
  <h1 class="text-center">Maps of India</h1>
  <div class="spacer10"></div>
  <div class="col-xs-12 col-md-4 acc_scon">
    <img class="acc_zoom" src='<?php echo images_path("about_chart/state_data.png");?>' data-zoom-image="<?php echo images_path("about_chart/state_data.png");?>" alt="Add Folders" />
    <h3>Explore statewise data of India in our Map charts</h3>
  </div>
  <div class="col-xs-12 col-md-4 acc_scon">
    <img class="acc_zoom" src='<?php echo images_path("about_chart/compare_states.png");?>' data-zoom-image="<?php echo images_path("about_chart/compare_states.png");?>" alt="timeseries statewise data" />
    <h3>You can compare data between several states.</h3>
  </div>
  <div class="col-xs-12 col-md-4 acc_scon">
    <img class="" src='<?php echo images_path("about_chart/save_mdata.png");?>' />
    <h3>Save time series data of states in My Charts.</h3>
  </div>
  <div class="spacer10"></div>
  <div class="col-xs-12"><hr></div>
  ...
  <div class="col-xs-12 col-md-4 acc_scon">
    <img class="acc_zoom" src='<?php echo images_path("about_chart/chatab_chart.png");?>' data-zoom-image="<?php echo images_path("about_chart/chatab_chart.png");?>chatab_chart.png" alt=" Charts And Tables" />
