			...
			<div class="modal-body">
				<form name="login_frm_ajx" id="login_frm_ajx" class="signup_frm" action="<?php echo url('/user/login');?>" method="post">
					...
					<div class="text-center form-group">
						...
						<a class="reg_fb btn btn-fbsu" onclick="window.open('<?php echo url('auth/login/facebook',isset($product)? $product : 'premium');?>', '_blank', 'width=600,height=600,scrollbars=yes,status=yes,resizable=yes,screenx='+((parseInt(screen.width) - 600)/2)+',screeny='+((parseInt(screen.height) - 600)/2)+'');" href="javascript:void(0);"> 
					...
					<p class="download-logininfo">
						...
						<a href="<?php echo url('products');?>">Setup a <b>Premium  Account</b></a> to access our fee based service.
					</p>
				</form>
			</div>
...
<?php if(!isset($_SESSION['user']) && (thisController()=='home')){?>
<div class='popup'>
	<div class='cnt223' style='display:none'>
		<div class="POPUser">
		...
		<div id="Dv_login_wrapper">
			...
			<div class="ForPassword">
				<a href="<?php echo url('user/forgotpassword');?>">Forgot
					your password?</a>
				</div>
				<div class="sinup_orcon"><p>OR</p></div>
				<div class="chat_signlin">
					...
					<a class="reg_linkedin btn btn-fbsu" onclick="window.open('<?php echo url('auth/login/facebook',isset($product)? $product : 'premium');?>', '_blank', 'width=600,height=600,scrollbars=yes,status=yes,resizable=yes,screenx='+((parseInt(screen.width) - 600)/2)+',screeny='+((parseInt(screen.height) - 600)/2)+'');" href="javascript:void(0);"> 
					...
					<div class="col-xs-12 col-sm-9">
						<p>
							<!--<b> 
								...
								<a href="<?php echo url('user/myaccount');?>">Account details</a> . 
							</b>
							<br><br> Thank you again for being a IMA user and we welcome any feedback you like to share with us at 
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="embed-responsive embed-responsive-16by9">
					<!-- <iframe id="ytplayer" class="embed-responsive-item jmaVideo" src="https://www.youtube.com/embed/_4RA3oRRbho?autoplay=0" allowfullscreen></iframe> -->
					<div id="ytplayer"></div>
...
<!-- Compitaion Already registered user payment -->
<div class="modal fade compag_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
			...
			<div class="modal-body">
				<p>You have already registered for the competition. To go to the competition page please click <a href="<?php echo url('page/ideapitchcompetition/');?>">here</a>. Further, to upload your PPT for the competition click <a href="<?php echo url('page/upload_document/');?>">here</a>. </p>
			</div>
			<div class="modal-footer">
				<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
			</div>
