...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:fb="http://ogp.me/ns/fb#">
	<head>
		...
		<meta property="og:image" content="<?php echo !isset($renderResultSet['meta']['shareImage']) ? images_path("slider/slider1.jpg"):'https://www.indiamacroadvisors.com/public/uploads/ckImages/'.$renderResultSet['meta']['shareImage'];?>" />
		...
		<meta name="twitter:site" content="@IndiaMAdvisors">
		<meta name="twitter:title" content="<?php echo !isset($renderResultSet['meta']['shareTitle']) ? 'India economy | Macro economy | Economist - GDP, Inflation - Analysis on Indian economy by Mr. Takuji Okubo' : $renderResultSet['meta']['shareTitle']; ?>">
		<meta name="twitter:description" content="<?php echo $renderResultSet['meta']['description'];?>">
		<meta name="twitter:image" content="<?php echo !isset($renderResultSet['meta']['shareImage']) ? images_path("slider/slider1.jpg") : 'https://www.indiamacroadvisors.com/public/uploads/ckImages/'.$renderResultSet['meta']['shareImage'];?>">
		...
		<link rel="shortcut icon" href="<?php echo asset('/favicon.ico'); ?>" type="image/icon">
		...
		<?php  $getPara=is_array(app('request')->route()->parameters()) ? array_values(app('request')->route()->parameters()):'';  ?>
		
		@includeIf('seoschema.'.end($getPara))
			<?php if(thisController()=='page'){ ?>
		<script type="application/ld+json">
		{
		  "@context":"https://schema.org/",
		  "@type":"Dataset",
		  "name":"<?php echo $renderResultSet['meta']['shareTitle']; ?>",
		  "description":"<?php echo $renderResultSet['meta']['description']; ?>",
		  "url":"https://www.indiamacroadvisors.com/page/category/<?php echo $renderResultSet['pageUrl']; ?>",
		  "keywords":["<?php echo $renderResultSet['meta']['keywords']; ?>"],
		"temporalCoverage": "<?php echo $renderResultSet['temporalCoverage']; ?>",
		"spatialCoverage": "India",
		  "license" : "https://www.indiamacroadvisors.com/aboutus/termsofuse/",
		  "creator":{
		  "@type":"Organization",
		  "url": "https://www.indiamacroadvisors.com/",
		  "name":"India Macro Advisors",
		  "contactPoint":{
		  "@type":"ContactPoint",
	...
	<body>
		...
		if(in_array(thisController(), $highstock_src_) || thisMethod()=='archive_pdf'){
		if(isMobileDevice()){ ?>
		@include('templates.script_template_mobile')
		<?php
		} else { ?>
		...
		<header>
			<?php if(isMobileDevice()){ ?>
			@include('templates.mobile_navigation')
			<?php } else { ?>
			@include('templates.desktop_navigation')
			<?php } ?>
				...
				<div class="carousel-inner <?php echo $smallBan_Name;?>" role="listbox">
					...
					<div class="item <?php echo ($b==0)?"active":'';?>">
						...
						<div class="carousel-caption">
							...
							<h4 data-animation="animated flipInX">CONCISE AND INSIGHTFUL ANALYSIS ON THE INDIAN ECONOMY & COVID-19</h4>
		...
		<?php if(thisController()== 'page' || thisMethod() == 'archive_pdf'){?> fileload = 'page'; <?php } ?>
