...
global.transporter = nodemailer.createTransport({
  service: 'Gmail',
  auth: {
      user: 'info@japanmacroadvisors.com',
      pass: '3)3F^#rL'
  }
});
// mailer.SMTP = {
...
global.LinkedInStrategy = require("passport-linkedin-oauth2").Strategy;
...
const { parsed: env_variables } = result;

global.env = function(para) {
  //console.log(env_variables[para]);
  if (env_variables[para] != "") return env_variables[para];
  else return "";
};
if (env("APP_ENV") != "development")
  global.saveFilePath = path.resolve(__dirname, "./uploads/") + "/";
else global.saveFilePath = "./uploads/";
