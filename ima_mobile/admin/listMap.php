...
if($_REQUEST['delete'] == 'true'){
    $chartObj->deleteMapdetails($_REQUEST['gid']);
	$chartObj->deletemap_values($_REQUEST['gid']);
			...
			<div id="table-content">
				...
				<tr>
					...
					<th class="table-header-repeat line-left minwidth-1"><a href="">Source </a></th>
                                ...
                                <?php 
                                    $getGraph = $chartObj->getMapList(); //print_r($getGraph);
                                    if(count($getGraph)>0){
                  ...
                  <tr class="<?php echo $class?>">	 
					...
					<a href="editMap.php?id=<?php echo $getGraph[$i]['gid'];?>" title="Edit" class="icon-1 info-tooltip"></a>
					<a href="listMap.php?delete=true&gid=<?php echo $getGraph[$i]['gid'];?>" title="Delete" class="icon-2 info-tooltip"></a>					
					<a href="viewMap.php?id=<?php echo $getGraph[$i]['gid'];?>" title="View" class="icon-3 info-tooltip"></a>					</td>
				</tr>
                                <?php
                                       }
                                   }
