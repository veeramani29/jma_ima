        ...
        $('#add_graph').submit(function() {
            ...
            if(title == ''){
			 ...
			 if(gFile != '' && checkFile(gFile) == false){
                $('#graph_File_error').html('Please upload only excel file.');
                ret =  false;
            }
	...
	<td>
		...
		<!-- start id-form -->
				...
				<div class="error_sent_notification"><?php echo $errorMsg;?></div>
	             <?php } ?>
                    <table border="0" cellpadding="0" cellspacing="0"  id="id-form">
                          <tr>
                            ...
                            <td>
                                ...
                                <label for="graph_source" class="error" id="graph_source_error"></label>
                            </td>
                            <td></td>
                          </tr> 
                          ...
                          <tr>
                            ...
                            <td>
                                ...
                                <label for="graph_title" class="error" id="graph_title_error"></label>
                            </td>
                            <td></td>
                          </tr>
                    ...
                    <tr>
                            ...
                            <td>
                                ...
                                <textarea  name="graph_txt" id="graph_txt" cols="5" rows="8"  ><?php echo $description; ?></textarea>
						<script type="text/javascript">
						   if ( typeof CKEDITOR == 'undefined' ){}
							...
							CKFinder.SetupCKEditor( editor, '../public/plugins/ckeditor/' ) ;
                                ...
                                <label for="graph_txt" class="error" id="graph_txt_error"></label>
                            </td>
                            <td></td>
                    </tr>
                 ...
                 <tr>
                            <th>Upload File:</th>
                            <td><?php echo $filepath; ?>
                                <input type="file" name="graph_File" id="graph_File" class="file_1" />
                                <label for="graph_File" class="error" id="graph_File_error"></label>
                            </td>
                ...
                <tr>
                    <th>&nbsp;</th>
                    <td valign="top">
                            <input type="submit" value="Submit" name="addGraph" class="form-submit" />
