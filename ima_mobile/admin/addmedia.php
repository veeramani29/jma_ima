...
<script language="javascript">
  ...
  function checkImg(imagePath) {
    ...
    if((fileType == ".gif") || (fileType == ".jpg") || (fileType == ".jpeg") || (fileType == ".png") || (fileType == ".GIF") || (fileType == ".JPG") || (fileType == ".PNG") || (fileType == ".pdf")) {
    return true;
    } else {
    return false;
    }
                 ...
                 $errorMsg = $errorMsg .'Please enter media link.<br/>';
                    ...
                    // image upload
                     if($_FILES['imageFile']['name'] != ''){                       
                            ...
                            if($ext!='.jpeg' && $ext!='.jpg' && $ext!='.gif' && $ext!='.png' && $ext!='.pdf'){
				...
				<div class="error_sent_notification"><?php echo $errorMsg;?></div>
	             <?php } ?>
                    ...
                    <tr>
                      ...
                      <a onclick="showCalendarControl(add_media.startDate,'add_media.txt_startDate');"><img src="calendar/calendar.gif"  border="0" /></a> 
						</td>
                        <td></td>
                      </tr>
                      <tr>
