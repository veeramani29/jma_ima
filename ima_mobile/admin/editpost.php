...
<script language="javascript">
    $(document).ready(function() {
		...
		/*tinymce.init({
			...
			external_plugins: {
				'lineheight': '/js/tinymce-line-height-plugin-master/lineheight/plugin.min.js'
			},
			templates: [{
							...
							$domain = 'mg.indiamacroadvisors.net';
							  ...
							  if(!empty($usersList))
							  {
								...
								if(env('APP_ENV')=="development" || env('APP_ENV')=="test")
								{
									...
									{
										$link = 'http://localhost/ima_laravel/page/category/'.$posrURL;
										if($category_array[0][1]== "Breaking News")
										{
											$link = 'http://localhost/ima_laravel/reports/view/breaking-news/'.$_POST['post_url'];
										}
									}
									else if(env('APP_ENV')=="test")
									{
										$link = 'https://laravel.indiamacroadvisors.com/page/category/'.$posrURL;
										if($category_array[0][1]== "Breaking News")
										{
											$link = 'https://laravel.indiamacroadvisors.com/reports/view/breaking-news/'.$_POST['post_url'];
										}
									}
									else
									{
										$link = 'https://www.indiamacroadvisors.com/page/category/'.$posrURL;
										if($category_array[0][1]== "Breaking News")
										{
											$link = 'https://www.indiamacroadvisors.com/reports/view/breaking-news/'.$_POST['post_url'];
										}
									}
