        ...
        <div class="row">
          <div class="col-xs-12">
            ...
            switch ($user_details['user_status']) {
              ...
              break;
              case 'active': ?>
               <?php if($user_details['user_type_id'] ==2): ?>
                <?php echo $__env->make('user.myaccount_user_trial', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
               <?php else: ?>
                 <?php echo $__env->make('user.myaccount_user_active', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
               <?php endif; ?>
              <?php break;
              case 'expired':
