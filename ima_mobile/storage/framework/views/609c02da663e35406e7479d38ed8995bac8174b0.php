                    ...
                    <p align="center" class="text-danger" <?php if(isset($result['status']) && $result['status']!=1) { ?> style="display: none"
                      ...
                      <div class="cols-1 brb_lininbtn" >
                        <div class="col" >
                          <a class="reg_linkedin"  href="<?php echo url('user/linkedinProcess');?>">
                            <img alt="Linkedin Signup" src="<?php  echo images_path("linkedin_signup.jpg"); ?>" alt="sign up image">
                          </a>
                          <p>OR</p>
                        </div>
                      </div>
                      ...
                      <div class="cols-1">
                        <div class="col suf_paratxt">
                          <p>Premium and Corporate subscriptions are our fee based service. For further information please see our <a target="_blank" href="<?php echo url('products');?>">products</a> </p>
