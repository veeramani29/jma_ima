...
<div class="col-md-8">
  ...
  <div class="spacer10f"></div>
  <form class="cmxform signup_frm form-horizontal" name="razorpayform" action="<?php echo url('user/dopayment');?>" method="POST" id="payment-form_" autocomplete="off">
    <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
    <input type="hidden" id="razorpay_payment_id" name="razorpay_payment_id" >
    <input type="hidden" id="razorpay_signature" name="razorpay_signature" >
      <input type="hidden" id="razorpay_subscription_id" name="razorpay_subscription_id">
 ...
 <img alt="stripe" src="<?php echo images_path('payment/pp.png');?>" >
      ...
      <div class="col-xs-12 pricing_corporate">
        ...
        <br>
        <p class="text-center" >Log in to your paypal account to complete the subscription.</p>
      </div>
    </div>
      </div>
    ...
    <div class="panel panel-default dopay_carpan">
     <div class="panel-heading">
        ...
        <div id="cc-option" class="panel-collapse collapse in">
      <div class="panel-body">
       <div class="col-xs-12">
      ...
      <div class="col-md-12 ">
        <button type="submit" class="btn btn-primary" name="submit-button" value="Submit"> Continue </button>
      </div>
    </div>
...
<div class="col-xs-12 col-md-4 secpay_con">
  ...
  <div class="spc_img">
    <a data-toggle="modal" data-target=".secpay_modal">
      <img src="<?php echo images_path("app-razorpay-title-screenshot.png");?>" alt="Razorpay by stripe">
    </a>
  ...
  <div class="text-center">
    <!--cards-v-->
    <img alt="Razorpay" src="<?php echo images_path('Guaranteed_Safe_Checkout_12.png');?>" >
  </div>
</div>
