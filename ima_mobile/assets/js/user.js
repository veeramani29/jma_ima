...
define(['module','require','jquery','jqueryCookieBar','jqueryValidate','bootstrap','Jma','intlTelInputMin','slickMin',], function(module,require,$,jqueryCookie,validate,bootstrap,JmaCla,intlTelInput,slick){
	$.ajaxSetup({
        headers: {
