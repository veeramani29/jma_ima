<div class="col-xs-12 col-md-4 content_rightside">
	 ...
	 <div class="preres_list effect8">
			...
			{ 
				 ...
				 { 
					...
					{ ?>
						<div class="prl_con">
							<div><a class="pc_text" href="<?php echo $notice['media_link'];?>" target="_blank"><?php echo $notice['media_value_text'];?></a></div>
							<div><a href="<?php echo $notice['media_link'];?>" target="_blank" data-toggle="tooltip" data-placement="left" title="Open&nbsp;Indicator&nbsp;Page"><i class="fa fa-paper-plane-o" aria-hidden="true"></i></a></div>
						</div>
					...
					{ ?>
					 ...
					 <div class="prl_con">
						<div><a class="pc_text" href="<?php echo 'public/uploads/media/'.$notice['media_value_img'];?>" target="_blank"><?php echo $notice['media_value_text'];?></a></div>
						<div><a href="<?php echo $notice['media_value_img'];?>" target="_blank" data-toggle="tooltip" data-placement="left" title="Open&nbsp;PDF&nbsp;File"><i class="fa fa-file-pdf-o" aria-hidden="true"></i></a></div>
					</div>
					<?php }
