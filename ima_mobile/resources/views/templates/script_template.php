...
<div class="h_graph_graph_area">
	...
	<input type="checkbox" value="checkbox" name="multiaxis_checkbox__{{chartIndex}}" id="multiaxis_checkbox__{{chartIndex}}" {{#if isMultiAxis}}checked{{/if}} onClick="JMA.JMAChart.switchToMultiAxisLine({{chartIndex}},this,true);"/>
	...
	<input type="checkbox" value="checkbox" name="barchart_checkbox__{{chartIndex}}" id="barchart_checkbox__{{chartIndex}}" {{#if isBarChart}}checked{{/if}} onClick="JMA.JMAChart.switchToBarChart({{chartIndex}},this,true);"/>
	<div class="control__indicator"></div>
	</label>
	</div>
	</div>
