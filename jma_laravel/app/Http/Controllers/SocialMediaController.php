...
class SocialMediaController extends Controller {
	public $Export_url;
		...
		{ 
			...
			$this->resizeImage('./public/socialmedia/_'.$unicCode.'.png', './public/socialmedia/'.$unicCode.'.png', 735, 384);
		...
		public function resizeImage($sourceImage, $targetImage, $maxWidth, $maxHeight, $quality = 90)
		{
			...
			imagecopyresampled($newImage, $image, 0, 0, 0, 0, 735, 384, $origWidth, $origHeight);
