...
tinymce.init({
            ...
            external_plugins: {
                'lineheight': '/admin/js/tinymce-line-height-plugin-master/lineheight/plugin.min.js'
            },
            templates: [{
...
$errorMsg = '';
 ...
 $usersList =  $userObj->getUserList();
  ...
  if(isset($_POST['postAdd'])){
    ...
    $recent_data =$insertArray['recent_data'] = $_POST['recent_data'];
    if($postType=='N')
        $premium_news =$insertArray['premium_news'] =  isset($_POST['premium_news'])?$_POST['premium_news']:'';
                 ...
                 <?php } ?>
                   ...
                   <!--  <script type="text/javascript">
                    ...
                    <tr>
                            ...
                            <td>
                                 <input type="text" name="meta_title" id="meta_title" class="inp-form"  />
                            </td>
                            <td></td>
                    </tr>
                      <tr>
                            ...
                            <td>
                                 <input type="text" name="share_title" id="share_title" class="inp-form"  />
                            </td>
                            <td></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                            ...
                            <td>
                                 <input type="text" name="meta_keywords" id="meta_keywords" class="inp-form2"  />
                            </td>
                            <td></td>
                    </tr>
                    <tr>
                            ...
                            <td>
                                 <input type="text" name="meta_description" id="meta_description" class="inp-form2"  />
                            </td>
                            <td></td>
                    </tr>
...
<tr id="premium_news_">   
                    ...
                    <td >
                            <input type="radio" value="Y" name="premium_news" id="premium_news"    /> Yes
                            <input type="radio" value="N" name="premium_news" id="premium_news"    />  No
                    ...
                    <tr>   
                    <th>Recent data hide to free user ?:</th>
                    <td >
                            <input type="radio" value="Y" name="recent_data" id="recent_data"   < /> Yes
                            <input type="radio" value="N" name="recent_data" id="recent_data"   <?php echo "checked";  ?> />  No
