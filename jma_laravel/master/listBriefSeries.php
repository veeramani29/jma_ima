		...
		<div id="content-table-inner">
			...
			<div id="table-content">
				...
				<tr class="<?php echo $class?>">
					...
					<td><?php if($getBriefSeries[$i]['briefseries_type'] == 'general' || $getBriefSeries[$i]['briefseries_type'] == 'oxford') { ?><img src="../<?php echo $getBriefSeries[$i]['briefseries_title_img'];?>" width="100" height="100" alt="brief series image"><?php } ?></td>

					<!-- <td><?php if($getBriefSeries[$i]['briefseries_type'] == 'general' || $getBriefSeries[$i]['briefseries_type'] == 'oxford') { ?><img src="../image.php?path=<?php echo $getBriefSeries[$i]['briefseries_title_img'];?>&w=100&h=100"><?php } ?></td> -->
