                    ...
                    //$doc_path1 = '';
                     ...
                     if($_FILES['graph_File']['name'] != ''){                       
                            ...
                            if(!in_array($ext, $file_ext)){// && $ext!='.csv'
                                    $errorMsg = 'File must be xls or xlsx or csv';
                            }
                            else{
...
//echo "<pre>";print_r($handle);echo "</pre>";exit;
	if($handle)
	{
...
$sheet = $xlsx->getSheet($sheetNames[1]);//print_r($sheet);exit;
