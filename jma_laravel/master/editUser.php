	...
	<td>
		...
		<!-- start id-form -->
                 <form name="edit_user" id="edit_user" method="POST">
					...
					<?php if($linkedin_enabled == 'Y')
					{ 
                        $linkedinUser = $userObj->getIndiviualLinkedInUser($userId);
				    ?>
					
                    <tr>
					    <td>Linkedin Additional Details</td>
					</tr>  
                    <tr>
					    <th>Industry:</th>
						<td><?php echo $linkedinUser[0]['industry'] ?></td>
					</tr>
					<tr>
					    <th>Company Name:</th>
						<td><?php echo $linkedinUser[0]['company_name'] ?></td>
					</tr> 
					<tr>
					    <th>Company Industry:</th>
						<td><?php echo $linkedinUser[0]['company_industry'] ?></td>
					</tr> 
