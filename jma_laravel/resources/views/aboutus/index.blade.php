...
<div class="col-md-7 col-xs-12">
	<div class="row">
		<div class="col-md-12">
			...
			<p class="lgray">Japan Macro Advisors<!-- <br /> Takuji Okubo --></p>
	...
	<!--<div class="our_team">
		<div class="row ot_member">
			<div class="col-sm-3 col-xs-12 ot_img">
				<img src="<?php //echo images_path('about_akira.png');?>" alt="Takuji" >
			</div>
			<div class="col-sm-9 col-xs-12 ot_content">
				<h4>Akira Morita</h4>
				<p class="lgray"><?php //if(Session::has('lang') && Session::get('lang')=='jp'){echo 'シニアコンサルタント';}else{echo 'Contributing Senior Analyst';}?></p>
				<p class="ot_readmore">
					Akira is an entrepreneur and business consultant. He worked at an European fintech, BIMA, as its Country Manager in Bangladesh between 2017-2019. He was also an Associate at Citigroup, working in its Corporate Banking group. Akira holds an MBA from INSEAD and Master of Public Policy (Economic Policy) from University of Tokyo.
				</p>
			</div>
		</div>
		</div>-->
		...
		<div class="row ot_member">
			<div class="col-sm-3 col-xs-12 ot_img">
				<img alt="Komagata" src="<?php //echo images_path("komagata.png");?>" alt="team image">
			</div>
			<div class="col-sm-9 col-xs-12 ot_content">
