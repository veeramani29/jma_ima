...
<div class="col-xs-12 col-md-8" ><!--Register section starts here-->
  ...
  <div class="main-title">
    <h1>
      ...
      <sup><i style="color:#22558F;" class="fa fa-star fa-fw"></i></sup>STANDARD Subscription plan
    </h1>
    <div class="mttl-line"></div>
  </div>
  ...
  <div class="default-padding">
	<?php if(thisController()=='custom') { ?>
		<ul class="list-unstyled">
      <li class=""><i class="fa fa-check-square-o" aria-hidden="true"></i> Costs USD 100/year<sup>*</sup></li>
    </ul>
	<?php } else { ?>
    <ul class="list-unstyled">
  ...
  <form class="cmxform signup_frm form-horizontal" action="<?php if(thisController()=='custom') {echo url('custom/dopayment');}else{ echo url('user/dopayment');}?>" method="POST" id="payment-form" autocomplete="off">
 ...
 <strong > <a data-toggle="collapse" class="accordion-toggle collapsed" data-parent="#accordion2" href="#paypal">Pay with my PayPal account  (Option 1):</a> </strong>
 <img alt="stripe" src="<?php echo images_path('payment/pp.png');?>" >
       
      </div>
      <div id="paypal" class="panel-collapse collapse in">
        <div class="panel-body">
       <div class="form-group text-center" >
      <div class="col-xs-12 pricing_corporate">
        <a href="<?php echo url('/user/dopayment_paypal');?>" class="btn btn-primary btn-long" > 
        ...
        <br>
        <p>Log in to your paypal account to complete the subscription.</p>
      </div>
    </div>
      </div>
    ...
    <!--   <div class="panel panel-default dopay_bill">
      <div class="panel-heading text-center"><strong class="text-center">(OR)</strong></div>
     
      </div> -->

    <div class="panel panel-default dopay_carpan">
      <div class="panel-heading">
        <strong><a data-toggle="collapse" class="accordion-toggle" data-parent="#accordion2" href="#cc-option">Pay with your debit or credit card  (Option 2):</a> </strong>
        <img alt="stripe" src="<?php echo images_path('stripe-logo.png');?>" >
      </div>
        <div id="cc-option" class="panel-collapse collapse">
      <div class="panel-body">
        ...
        <div class="col-xs-12 col-lg-6">
          <div class="form-group">
            ...
            <!-- <input type="text" name="card_number" class="form-control" id="card_number" placeholder="1234 5678 9012 3456"> -->
            <!-- <input type="text" size="20" placeholder="Card number *" maxlength="16" name="card-number" value="<?php echo (isset($_REQUEST['card-number']))?$_REQUEST['card-number']:'';?>"  autocomplete="off" class="form-control card-number stripe-sensitive required" style="" /> -->
          </div>
        </div>
        ...
        <div class="col-lg-4 col-xs-12">
          <div class="form-group">
            <input type="text" size="4" maxlength="4" onkeypress="return IsPhoneNumber(event);" placeholder="YYYY *" name="card-expiry-year" value="<?php echo (isset($_REQUEST['card-expiry-year']))?$_REQUEST['card-expiry-year']:'';?>" class="form-control card-expiry-year" />
          </div>
        </div>
        <div class="col-lg-4 col-xs-12">
          <div class="form-group">
            <input type="password" size="4" onkeypress="return IsPhoneNumber(event);" placeholder="Card security code *" maxlength="4" autocomplete="new-password" class="form-control card-cvc"  />
          </div>
        </div>
		<div class="col-xs-12 dopay_bill">
          <div class="form-group">
            <label class="control control--checkbox">
              I accept the <a data-toggle="modal" data-target="#terms_Model">terms of use </a><br>
			 <?php if(thisController()=='custom') { ?> <sup>*Student concession</sup><?php } ?>
          ...
          <div class="form-group text-center" >
      <div class="col-xs-12 pricing_corporate">
        <button type="submit" class="btn btn-primary btn-long" name="submit-button" value="Submit"> 
          <?php if(Session::has('user') && Session::get('user.user_type_id')=='1'){ ?>
          Start Free Trial
          <?php }else{ ?>
  ...
  <div class="spc_img">
    <a data-toggle="modal" data-target=".secpay_modal">
      <img src="<?php echo images_path("powered_by_stripe.png");?>" alt="Powered by stripe">
           ...
           <a data-toggle="modal" data-target=".paypal_modal">
...
<script type="text/javascript" src="<?php echo asset("assets/plugins/payment/jquery.payment.js");?>" ></script>
<script type="text/javascript">
// this identifies your website in the createToken call below
Stripe.setPublishableKey('<?php echo $result['stripe_publish_key']; ?>');
$(function() {
  ...
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <p>Following the initial service period, JMA reserves the right to increase the Monthly Fee at any time upon 30 days notice to you, provided you shall have the right to terminate the Subscription by choosing Unsubscribe which turn back your subscription type to Free subscription from Standard subscription.  </p>
        ...
        <p>Free subscription term/period is unlimited. Standard subscription and Corporate subscription will end after the expiration date until you cancel the subscription. Corporate subscription expiration will be handled by JMA and will terminate until user cancels his corporate subscriptions or send the 30 day notice to us. Once you cancel your subscriptions you will be notified via email and your subscription type will turn back to Free subscription. If you encounter any problem, please feel free to contact us at <a href="mailto:support@japanmacroadvisors.com">support@japanmacroadvisors.com</a> or you can submit your query at our <a href="<?php echo url('helpdesk/post/');?>">Help Desk</a>.</p>
        <div class="sub-title">
          <h5>No Refund</h5>
          <div class="sttl-line"></div>
        </div>
        <p>The credit card which you provide will automatically and immediately be billed for the Services you subscribe to. While in trial period the card will be charged only after the trial period ends on the expiration date. Standard subscription will be charged in JPY and corporate subscription in USD. If you cancel your Services you will no longer be billed but no money already paid will be refunded. If your credit card is invalid for any reason, JMA has the right to terminate the Services immediately.</p>
        <div class="sub-title">
...
<script type="text/javascript" src="<?php  echo asset("assets/plugins/cc-validator/creditCardValidator.js");?>" ></script>
<script>
$(function() {
