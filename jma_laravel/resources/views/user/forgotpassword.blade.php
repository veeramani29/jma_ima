...
<div class="sttl-line"></div>
    ...
    <form name="forgotpasswd_frm" id="forgotpasswd_frm" role="form" class="form-horizontal"  method="post" >
...
<div class="col-md-10">
<input type="email" value="<?php echo isset($_POST['forgotpasswd_email'])?$_POST['forgotpasswd_email']:'';?>" name="forgotpasswd_email" placeholder="Enter email" id="forgotpasswd_email" class="form-control required" /> 
