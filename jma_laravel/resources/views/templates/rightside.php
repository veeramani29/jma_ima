...
<div class="col-xs-12 col-md-3 rightside_con">
	<div class="right_intvid">
		...
		<a data-toggle="modal" href="https://www.youtube.com/embed/LdYLAC19HWc?ecver=2" class="int-ytvideos effect2" data-target=".int-jmamodvid">
			<span class="hidden">New Features by JMA</span>
	...
	<ul class="list-group" id="dv_client_sp_links">
		<?php if(Session::has('user.user_permissions.user.profile.allowedit') && Session::get('user.user_permissions.user.profile.allowedit') == 'Y') { ?>
		<li class="list-group-item" >
			<i class="fa fa-pencil-square" style="color:#e60013;font-size:14px;"></i>&nbsp;
			<a href="<?php echo url('/user/myaccount');?>" class="<?php if(thisController() == 'user'  && thisMethod() == 'profile') { echo "selected"; } else { ""; }?>">Edit my Profile</a>
		</li>
		<?php }?>
		<!-- <li class="list-group-item" ><i class="fa fa-envelope-o" style="color:#e60013;font-size:14px;"></i>&nbsp;
			<a href="<?php echo url('/helpdesk/post');?>" class="<?php if(thisController() == 'helpdesk' &&  thisMethod() == 'post') { echo "selected"; } else { ""; }?>">Help Desk</a>
		</li> -->
	</ul>
	<?php }?>
