...
(function (factory) {
	...
	var utils = {
		...
		showInput: function (e) {
			...
			input.innerHTML = '<input type="text" class="annotation-' + index + '" placeholder="Add text"><button class="annotation"> Done </button>';
			...
			button.onclick = function () {
				...
				$('body').on('click',function(e) {
					...
					if($(e.target).hasClass('annotation')){
							var find_order=chart.renderTo.attributes[2].value;
			...
			//After Drawing unselect The annotaions
			/*chart.annotations.allowZoom = true;
			chart.annotations.selected = -1;
			$('ul.list_annotations li').removeClass('select')*/
		}
	};
